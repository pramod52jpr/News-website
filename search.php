        ...
        <div class="news-container">
            <div class="news">
                    ...
                    <?php if(mysqli_num_rows($result)>0){
                        ...
                        <div class="news-item">
                            ...
                            <div>
                                ...
                                <a href="<?php echo 'category.php?cid='.$row['c-id']; ?>" class="features" style="margin-top:5px;display:inline-block"><?php echo $row['category']; ?></a>
                                <a href="<?php echo 'author.php?aid='.$row['User-Id'] ?>" class="features"><?php echo $row['First-Name'].' '.$row['Last-Name']; ?></a>
                ...
                <div class="pagination">
                    <?php if($page_index>1){ ?>
                        <a style="border-radius:8px 0px 0px 8px" href="<?php echo $_SERVER['PHP_SELF'].'?page='.($page_index-1).'&search='.$search; ?>">Prev</a>
                    <?php } ?>
                    <?php for($i=1;$i<=$page;$i++){ 
                        ...
                        echo "<a$active href='$_SERVER[PHP_SELF]?page=$i&search=$search'>$i</a>";
                    } ?>
                    <?php if($page_index<$page){ ?>
                        <a style="border-radius:0px 8px 8px 0px" href="<?php echo $_SERVER['PHP_SELF'].'?page='.($page_index+1).'&search='.$search; ?>">Next</a>
                    <?php } ?>
                </div>
            </div>
            <div class="sidebar">
                    ...
                    <marquee behavior="scroll" direction="up" height="520px" scrollamount="5" onmouseover="this.stop()" onmouseout="this.start()">
                        <div class="recent-news-container">
                            ...
                            $sql4="select * from post left join category on post.`category-id`=category.`c-id` left join 
                                    user on post.`Author-id`=user.`User-Id` limit 5";
                                ...
                                while($row4=mysqli_fetch_assoc($result4)){ ?>
                                    <div class="recent-news">
                                        ...
                                        <div>
                                            ...
                                            <a href="category.php?cid=<?php echo $row4['c-id'] ?>" class="category"><?php echo $row4['category'] ?></a>
                                            <span><?php echo join("/",array_reverse(explode("-",$row4['post-date']))); ?></span><br>
